...
export const MATERIAL_PRESETS = [
  {
    ...
    name: "Royal Steel",
    swatch: "#c6c9d1",
    case: { color: "#c9cbd2", metalness: 1.0, roughness: 0.12, emissive: "#000000", emissiveIntensity: 0 },
  ...
  },
  {
    ...
    swatch: "#caa084",
    case: { color: "#caa084", metalness: 1.0, roughness: 0.12, emissive: "#000000", emissiveIntensity: 0 },
  ...
  },
  {
    ...
    swatch: "#2b2d31",
    case: { color: "#2b2d31", metalness: 0.9, roughness: 0.28, emissive: "#000000", emissiveIntensity: 0 },
  ...
  },
  {
    ...
    name: "Obsidian Gold",
    swatch: "#141416",
    case: { color: "#101012", metalness: 0.4, roughness: 0.12, emissive: "#000000", emissiveIntensity: 0 },
